...
(function (global) {
  ...
  require.define('/PsyCloud.js', function (module, exports, __dirname, __filename) {
    (function () {
      var ConditionalSampler, CrossedFactorSpec, DataTable, Event, ExhaustiveSampler, ExpDesign, Experiment, ExperimentContext, Factor, FactorSpec, MockStimFactory, Q, Sampler, StimFactory, Trial, UniformSampler, VarSpec, asArray, dt, rep, repLen, _, __hasProp = {}.hasOwnProperty, __extends = function (child, parent) {
