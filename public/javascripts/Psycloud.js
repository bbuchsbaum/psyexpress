...
(function (global) {
  ...
  require.define('/PsyCloud.js', function (module, exports, __dirname, __filename) {
    (function () {
      var ArrayIterator, Block, BlockSeq, CellTable, CombinatoricSampler, ConditionalSampler, DataTable, Event, EventData, EventDataLog, ExhaustiveSampler, ExpDesign, Experiment, ExperimentContext, ExperimentState, Factor, FactorNode, FactorSetNode, FactorSpec, GridSampler, ItemNode, Iterator, MatchSampler, MockStimFactory, Prelude, Presenter, Q, RunnableNode, Sampler, StimFactory, TaskNode, TaskSchema, Trial, TrialList, UniformSampler, VarSpec, VariablesNode, asArray, buildEvent, buildPrelude, buildResponse, buildStimulus, buildTrial, clone, deferred, des, msam, permute, prom, prom2, prom3, rep, repLen, sam, sample, _, _i, _ref, _results, __hasProp = {}.hasOwnProperty, __extends = function (child, parent) {
      ...
      exports.ExperimentState = ExperimentState = function () {
        ...
        ExperimentState.prototype.toRecord = function () {
          var key, value, _j, _len, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6;
          ({
            $blockNumber: this.blockNumber,
            $trialNumber: this.trialNumber,
            $eventNumber: this.eventNumber,
            $stimulus: (_ref1 = this.event) != null ? (_ref2 = _ref1.stimulus) != null ? _ref2.constructor.name : void 0 : void 0,
            $response: (_ref3 = this.event) != null ? (_ref4 = _ref3.response) != null ? _ref4.constructor.name : void 0 : void 0
          });
          if (((_ref5 = this.trial) != null ? _ref5.record : void 0) != null) {
            _ref6 = this.trial.record;
            for (value = _j = 0, _len = _ref6.length; _j < _len; value = ++_j) {
              key = _ref6[value];
              ret[key] = value;
            }
          }
