...
(function (global) {
  ...
  require.define('/main.coffee', function (module, exports, __dirname, __filename) {
    ...
    Exp = require('/Experiment.js', module);
    Psy = require('/Psytools.js', module);
    for (key in Psy) {
      value = Psy[key];
      exports[key] = value;
    }
  ...
  require.define('/Psytools.js', function (module, exports, __dirname, __filename) {
    (function () {
      var ConditionalSampler, DataTable, ExhaustiveSampler, ExpDesign, Experiment, ExperimentContext, Factor, ItemSet, Sampler, UniformSampler, asArray, exp, rep, x, _, __hasProp = {}.hasOwnProperty, __extends = function (child, parent) {
      ...
      exports.ExpDesign = ExpDesign = function () {
        ...
        function ExpDesign(spec) {
          var crossedItemSets, crossedItems, key, value, _ref;
          if (spec == null) {
            spec = {};
          }
          ...
          for (key in _ref) {
            ...
            if (value['type'] === 'Factor') {
              this.crossedVars[key] = value['levels'];
            }
          }
          this.crossedCells = this.crossVariables(this.crossedVars);
          console.log(this.crossedCells);
          crossedItems = this.itemSpec['Crossed'];
          crossedItemSets = ExpDesign.splitCrossedItems(crossedItems, this.crossedCells);
          console.log(crossedItemSets);
      ...
      exp = new ExpDesign(this.LexDesign);
      x = new DataTable({
        x: [
          1,
          2,
  ...
  require.define('/Experiment.js', function (module, exports, __dirname, __filename) {
    (function () {
      var Bacon, Blank, CanvasBorder, Event, FixationCross, KeypressResponse, KineticContext, MousepressResponse, Prompt, Psy, Q, Response, Sound, StartButton, Stimulus, Text, Timeout, Trial, TypedResponse, doTimer, _, __hasProp = {}.hasOwnProperty, __extends = function (child, parent) {
          for (var key in parent) {
            if (__hasProp.call(parent, key))
              child[key] = parent[key];
          }
      ...
      Bacon = require('/Bacon.js', module).Bacon;
      _ = require('/../node_modules/lodash/dist/lodash.js', module);
      ...
      exports.Timeout = Timeout = function (_super) {
        ...
        Timeout.prototype.activate = function (context) {
          console.log('timeout activated: ', this.duration);
      ...
      exports.Blank = Blank = function (_super) {
        ...
        function Blank(spec) {
          this.spec = spec != null ? spec : { backgroundColor: 'rgb(125,0,125)' };
        }
      ...
      exports.StartButton = StartButton = function (_super) {
        ...
        function StartButton(width, height) {
          this.width = width != null ? width : 150;
          this.height = height != null ? height : 75;
        }
        StartButton.prototype.render = function (context) {
          ...
          text = new Kinetic.Text({
            text: 'Start',
            x: xcenter - this.width / 2,
            y: ycenter - this.height / 2,
            width: this.width,
            height: this.height,
            fontSize: 30,
            fill: 'white',
          ...
          MouseBus = function () {
            function MouseBus(eventLayer) {
              ...
              this.handler = function (x) {
                console.log('caught mouse event');
  ...
  require.define('/Bacon.js', function (module, exports, __dirname, __filename) {
    (function () {
