...
#word3 = new Psy.Text({content: "Bye", position: "top-left", fill: "black", fontSize: 200})
...
#event6 = new Psy.Event(new Psy.Sound("/tasks/Capabilities/resources/pa.3.4.mp3"), new Psy.Timeout(2000))
