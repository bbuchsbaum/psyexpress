...
(function() {
  ...
  exports.Presenter = Presenter = (function() {
    ...
    Presenter.prototype.start = function(context) {
      var block, instructionsEvent, record, trialNum, trialSpec,
        _this = this;
