...
(function() {
  ...
  tmp1 = new EventData("hello", "24", {
    x: 8
  });

  tmp2 = new EventData("goodbye", "24", {
    x: 8
  });

  tmp3 = new EventData("goyyyyyy", "29", {
    x: 8
  });
