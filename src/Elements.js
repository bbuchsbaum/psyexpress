...
(function() {
  ...
  exports.Sequence = Sequence = (function(_super) {
    ...
    Sequence.prototype.genseq = function(context, layer) {
      var deferred, _i, _ref3, _results,
        _this = this;
      deferred = Q.defer();
      _.forEach((function() {
        _results = [];
        for (var _i = 0, _ref3 = this.stims.length; 0 <= _ref3 ? _i < _ref3 : _i > _ref3; 0 <= _ref3 ? _i++ : _i--){ _results.push(_i); }
        return _results;
