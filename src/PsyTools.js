...
(function() {
  var ConditionalSampler, CrossedFactorSpec, DataTable, Event, ExhaustiveSampler, ExpDesign, Experiment, ExperimentContext, Factor, FactorSpec, MockStimFactory, Q, Sampler, StimFactory, Trial, UniformSampler, VarSpec, asArray, rep, repLen, _,
  ...
  exports.ExperimentContext = ExperimentContext = (function() {
    ...
    ExperimentContext.prototype.clearBase = function() {};
  ...
  exports.Experiment = Experiment = (function() {
    ...
    Experiment.prototype.start = function(context) {
      var fun, funList, i, record, result, trialList, trialSpec, trials, _i, _len,
        _this = this;
      ...
      trialList = (function() {
        ...
        for (i = _i = 0, _ref = trials.nrow(); 0 <= _ref ? _i < _ref : _i > _ref; i = 0 <= _ref ? ++_i : --_i) {
          ...
          _results.push(this.buildTrial(trialSpec));
        }
        return _results;
      }).call(this);
