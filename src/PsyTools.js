...
(function() {
  var ConditionalSampler, CrossedFactorSpec, DataTable, ExhaustiveSampler, ExpDesign, Experiment, ExperimentContext, Factor, FactorSpec, Sampler, StimFactory, UniformSampler, VarSpec, asArray, exp, rep, repLen, _,
  ...
  exports.MockStimFactory = StimFactory = (function() {
  ...
  exports.Experiment = Experiment = (function() {
    ...
    function Experiment(designSpec) {
      ...
      this.stimFactory = new MockStimFactory();
      console.log(this.display);
    }

    Experiment.prototype.buildStimuli = function(event) {
      var params, stimType;
    ...
    Experiment.prototype.buildTrial = function(eventSpec) {
      var key, next, stims, value, _results;
      ...
      for (key in eventSpec) {
        ...
        _results.push(this.buildStimuli(stims));
      }
      return _results;
    };
    ...
    Experiment.prototype.start = function(context) {
      ...
      for (i = _i = 0, _ref = trials.nrow(); 0 <= _ref ? _i < _ref : _i > _ref; i = 0 <= _ref ? ++_i : --_i) {
        ...
        gentrial = this.trialGenerator(trial);
        _results.push(this.buildTrial(gentrial));
      }
      return _results;
    };
  ...
  exp = new Experiment(this.LexDesign);
