...
(function() {
  var ConditionalSampler, CrossedFactorSpec, DataTable, ExhaustiveSampler, ExpDesign, Experiment, ExperimentContext, Factor, FactorSpec, Sampler, UniformSampler, VarSpec, asArray, f1, f2, f3, f4, out, rep, x, x2, x3, y, _,
  ...
  exports.ConditionalSampler = ConditionalSampler = (function(_super) {
    ...
    ConditionalSampler.prototype.take = function(n) {
      var keys;
      keys = rep(_.keys(this.keyMap), n);
      return this.takeCondition(keys);
    };
  ...
  exports.ExpDesign = ExpDesign = (function() {
    ...
    function ExpDesign(spec) {
      ...
      console.log("crossed expanded", this.crossedSpec.expanded);
  ...
  out = _.reduce([x, x2, x3], function(sum, nex) {
